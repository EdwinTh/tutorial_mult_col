...
gg_biplot <- function(pca_object, 
  ...
  # you can build the plot directly from cols, loadings, cases
  # this might still be challenging if you don't know ggplot too well
